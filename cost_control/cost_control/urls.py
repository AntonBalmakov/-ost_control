"""cost_control URL Configuration
...
schema_view = get_schema_view(
   openapi.Info(
      ...
      contact=openapi.Contact(email="contact@control.local"),
      license=openapi.License(name="Mytest License"),
   ),
   public=True,
...
urlpatterns = [
    ...
    path("expenses/", include('cost_app.urls')),
