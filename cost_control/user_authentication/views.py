...
from .serializer import LoginSerializer, RequestPasswordResetEmailSerializer, SetNewPasswordSerializer
...
class RegisterView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        user = User.objects.get(email=user_date['email'])
...
class VerifyEmail(views.APIView):
    ...
    token_param_config = openapi.Parameter('token', in_=openapi.IN_QUERY,
                                           description='Descriptions', type=openapi.TYPE_STRING)
